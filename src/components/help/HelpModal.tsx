...
const HelpModal = ({ isOpen, onClose }) => {
  ...
  const sections = {
    general: [
      {
        title: "Qu'est-ce que CommunityApp ?",
        content: "CommunityApp est un réseau social dédié au partage d'activités et d'expériences. Notre plateforme permet aux utilisateurs de découvrir, créer et participer à des activités dans leur région."
      },
      {
        title: "Comment créer un compte ?",
        content: "Pour créer un compte, cliquez sur 'S'inscrire' en haut à droite. Remplissez le formulaire avec vos informations personnelles et validez votre email pour commencer à utiliser CommunityApp."
      }
    ],
    securite: [
      {
    ...
    contact: [
      {
        ...
        content: "Pour toute question technique, contactez-nous à support@CommunityApp.com. Notre équipe est disponible 7j/7 de 9h à 18h."
      },
      {
        title: "Suggestions",
        content: "Vos retours sont précieux ! Envoyez vos suggestions d'amélioration à feedback@CommunityApp.com."
      }
    ]
  };
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-lg w-full max-w-4xl max-h-[90vh] overflow-hidden relative">
        ...
        <div className="p-6">
          <h1 className="text-2xl font-bold text-gray-800 mb-6">Centre d'aide CommunityApp</h1>
